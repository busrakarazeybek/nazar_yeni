...
('c3d4e5f6-a7b8-9012-cdef-345678901234', 'fatma.ozturk@email.com', 'Fatma Öztürk', 'candidate', 24, 'female', 'Doğa yürüyüşlerini seven, aktif yaşam tarzına sahip biriyim.', ARRAY['Doğa', 'Yürüyüş', 'Fotoğrafçılık'], 'İzmir', 'Hemşire', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400', '+90555123003', true, true, NOW(), NOW(), 22, 28, ARRAY['İzmir', 'Antalya'], ARRAY['Doğa', 'Spor'], ARRAY['male']),

('d4e5f6a7-b8c9-0123-def0-456789012345', 'zeynep.yilmaz@email.com', 'Zeynep Yılmaz', 'candidate', 26, 'female', 'Teknoloji ve yazılım dünyasına meraklı, sürekli öğrenmeyi seven biriyim.', ARRAY['Teknoloji', 'Yazılım', 'Kitap'], 'İstanbul', 'Yazılım Geliştirici', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400', '+90555123004', true, true, NOW(), NOW(), 24, 30, ARRAY['İstanbul', 'Bursa'], ARRAY['Teknoloji', 'Kitap'], ARRAY['male']),

('e5f6a7b8-c9d0-1234-ef01-567890123456', 'merve.celik@email.com', 'Merve Çelik', 'candidate', 28, 'female', 'Mutfak sanatlarını seven, yemek yapmayı hobi edinmiş biriyim.', ARRAY['Yemek', 'Mutfak', 'Seyahat'], 'Bursa', 'Pazarlama Uzmanı', 'https://images.unsplash.com/photo-1488716820095-cbe80883c496?w=400', '+90555123005', true, true, NOW(), NOW(), 26, 33, ARRAY['Bursa', 'İstanbul'], ARRAY['Yemek', 'Seyahat'], ARRAY['male']),

('f6a7b8c9-d0e1-2345-f012-678901234567', 'seda.arslan@email.com', 'Seda Arslan', 'candidate', 23, 'female', 'Müzik ve dans etmeyi seven, enerjik ve sosyal biriyim.', ARRAY['Müzik', 'Dans', 'Sosyal'], 'Antalya', 'Müzik Öğretmeni', 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400', '+90555123006', true, true, NOW(), NOW(), 21, 27, ARRAY['Antalya', 'Muğla'], ARRAY['Müzik', 'Dans'], ARRAY['male']),

('a7b8c9d0-e1f2-3456-0123-789012345678', 'gamze.kurt@email.com', 'Gamze Kurt', 'candidate', 29, 'female', 'Spor yapmayı seven, sağlıklı yaşam tarzını benimseyen biriyim.', ARRAY['Spor', 'Fitness', 'Yoga'], 'İzmir', 'Fizyoterapist', 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=400', '+90555123007', true, true, NOW(), NOW(), 27, 34, ARRAY['İzmir', 'Ankara'], ARRAY['Spor', 'Sağlık'], ARRAY['male']),
...
('a9b0c1d2-e3f4-5678-2345-901234567890', 'murat.akgun@email.com', 'Murat Akgün', 'candidate', 26, 'male', 'Aşçılık tutkunu, mutfak sanatlarında uzman, yemek blogger''ıyım.', ARRAY['Yemek', 'Mutfak', 'Blog'], 'Bursa', 'Aşçı', 'https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=400', '+90555123019', true, true, NOW(), NOW(), 23, 29, ARRAY['Bursa', 'İstanbul'], ARRAY['Yemek', 'Yazı'], ARRAY['female']),

('b0c1d2e3-f4a5-6789-3456-012345678901', 'tuncay.demir@email.com', 'Tuncay Demir', 'candidate', 30, 'male', 'Fotoğrafçılık ve görsel sanatlar alanında çalışan, estetik anlayışı gelişmiş biriyim.', ARRAY['Fotoğraf', 'Sanat', 'Estetik'], 'Ankara', 'Fotoğrafçı', 'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?w=400', '+90555123020', true, true, NOW(), NOW(), 25, 32, ARRAY['Ankara', 'İstanbul'], ARRAY['Sanat', 'Fotoğraf'], ARRAY['female']);